...
// ClientWrapper wraps the existing backend codex.Client to adapt it for
// harness use. It delegates all API calls to the underlying client.
type ClientWrapper struct {
	inner *backendCodex.Client
}

// NewClientWrapper creates a wrapper around an existing Codex backend client.
func NewClientWrapper(client *backendCodex.Client) *ClientWrapper {
