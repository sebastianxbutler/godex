...
// ClientConfig holds configuration for a generic OpenAI-compatible client.
...
func (c *Client) ListModels(ctx context.Context) ([]harness.ModelInfo, error) {
	...
	models := make([]harness.ModelInfo, len(modelsResp.Data))
	for i, m := range modelsResp.Data {
		models[i] = harness.ModelInfo{ID: m.ID, Provider: c.cfg.Name}
	}
	return models, nil
}
